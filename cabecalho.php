    ...
    <div id="left-menu">
        <div class="sub-left-menu scroll">
            <ul class="nav nav-list">
                ...
                <li class="ripple">
                    <a class="nav-header" href="../Produto/index.php"><span class="fa fa-users"></span> Produtos</a>
                </li>
                <li class="ripple">
                    <a class="nav-header" href="../Marca/index.php"><span class="fa fa-hand-paper-o"></span> Marca</a>
                </li>

                <li class="ripple">
                    <a class="nav-header" href="../Modelo/index.php"><span class="fa fa-user"></span> Modelo</a>
                </li>
            </ul>
        </div>
    </div>

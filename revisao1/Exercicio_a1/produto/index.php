                        ...
                        <table id="datatables-example" class="table table-bordered table-hover table-striped table-condensed">
                            ...
                            <?php foreach ($aprodutos as $produto){
                                echo "
                                    <tr>
                                        <td>
                                            <a href='formulario.php?id_produto={$produto['id_produto']}'><span class='icons icon-note'></span></a>
                                        </td>
                                        <td>
                                            <a href='processamento.php?acao=excluir&id_produto={$produto['id_produto']}'><span class='fa fa-trash-o'></span></a>
                                        </td>
                                        <td>{$produto['nome']}</td>
                                        <td>{$produto['valor']}</td>

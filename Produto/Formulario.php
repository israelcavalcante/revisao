...
$marca = new Marca();
// Recuperando os dados de modelos
...
if (!empty($_GET['id_produtos'])) {
    $produto->carregarPorId($_GET['id_produtos']);
}
        ...
        <div class="col-md-12 panel-body" style="padding-bottom:30px;">
            <div class="col-md-6">
                <form enctype="multipart/form-data" action="processamento.php?acao=salvar" method="post" class="form-horizontal">
                    <input type="hidden" name="id_produto" value="<?php echo $produto->getIdprodutos(); ?>">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group" style="margin-top:40px !important;">
                    ...
                    <input type="file" class="form-text" id="foto" name="foto"
